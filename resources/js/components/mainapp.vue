        ...
        <div class="_1side_menu_content">
          ...
          <div class="_1side_menu_list">
            <ul class="_1side_menu_list_ul">
              ...
              <li><router-link to="tags"><Icon type="ios-create" /> Tags</router-link></li>
              <li><router-link to="category"><Icon type="md-cog" /> Category</router-link></li>
              <li><router-link to="adminusers"><Icon type="ios-body" /> Admin users</router-link></li>
              <li><a href="/logout"><Icon type="ios-close-circle" /> Logout</a></li>
            </ul>
          </div>
        </div>
      </div>
